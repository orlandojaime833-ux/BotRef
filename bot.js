...
const WEBHOOK_URL  = process.env.WEBHOOK_URL;          // obrigatório
...
server.listen(PORT, async () => {
  ...
  if (!WEBHOOK_URL) {
    console.error('❌ WEBHOOK_URL não definido no .env — webhook NÃO registado.');
    return;
  }

  // Regista o webhook no Telegram (idempotente — pode chamar várias vezes)
  try {
